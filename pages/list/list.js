...
Page({
  ...
  addToCart: function (e) {
    ...
    if (cartList[food.id] && cartList[food.id]!=null) {
    ...
    this.deleteUndefined( cartList)
    this.setData({
      cartList,
      cartPrice: this.data.cartPrice + cartList[food.id].price,
      cartNumber: this.data.cartNumber + 1
    })
    this.shopcartAnimate.start(e)
    this.deleteUndefined( this.data.cartList)
  },
  ...
  deleteUndefined:function(cartList){
